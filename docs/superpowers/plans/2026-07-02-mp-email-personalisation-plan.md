...
8. **Length targets**: Tier 1 **400-500 words** (bespoke opening 60-90w + base body ~240w + Maradona ~90w + bespoke closing 30-50w); Tier 2 **280-330 words** (role-templated opening 40-60w + trimmed body ~240w + Maradona ~90w + role closing 30-50w); Tier 3 **240-280 words** (no opening or closing changes; no Maradona). The original ~300-word target for Tier 1 was a spec mistake and has been corrected.
