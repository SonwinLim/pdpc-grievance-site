...
<h2 style="font-weight: normal; margin-bottom: 1.2em;">Dear <strong>Mr Gerald Giam Yean Song</strong>,</h2>

<p>Your work on civil liberties and digital rights gives you an established connection to the issue I want to raise. You have engaged with questions of data protection and individual rights before, and I hope this falls within the range of matters you are willing to examine further.

In March 2025. PDPC redesigned its enforcement-decisions website. A previously available filter that allowed segmentation of published cases by obligation type was removed. The effect was not data loss but data obscuration: the zero Access Obligation breach finding, visible to any researcher before the redesign, became inaccessible to most members of the public after it. No announcement accompanied this change.</p>
