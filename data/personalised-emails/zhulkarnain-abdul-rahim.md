...
PDPC responded to my complaint by redesigning its enforcement-website to remove the obligation-type filter. The new layout hid the zero-Access-Obligation-breach pattern entirely. I rebuilt the filter and published everything at pdpaaccessrights.sg so that the pattern is publicly visible.
