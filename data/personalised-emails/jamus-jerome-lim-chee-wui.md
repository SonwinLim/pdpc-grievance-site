---
tier: 1
name: Jamus Jerome Lim
slug: jamus-jerome-lim-chee-wui
email: jamus.lim@wp.sg
designation: Member of Parliament
subject: Follow-up on the PDPC grievance, an update and a request for your attention
---

Dear Mr Jamus Jerome Lim, your academic engagement with data policy and your background speaking on SME-related matters give you a particularly useful lens on what I want to raise. You have already demonstrated willingness to engage with empirical patterns in policy, and that is precisely what I am asking for here.

In March 2025. PDPC removed a filter from its published enforcement-decisions page. The filter had allowed users to segment cases by obligation type. After the redesign, that segmentation is no longer possible. The zero Access Obligation breach findings, which had been empirically visible in the data, became inaccessible to a non-technical user. This was not explained; it was simply changed.
