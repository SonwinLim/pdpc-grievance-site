...
PDPC responded to my complaint by redesigning its enforcement-website to remove the obligation-type filter that had made the disparity visible. I rebuilt the filter and published everything at pdpaaccessrights.sg.
...
The footage that would have shown me what happened was denied and then destroyed. I rebuilt the removed filter at pdpaaccessrights.sg. The consequences of that denial have shaped every day since. Does a matter affecting a statutory right granted to all Singaporeans warrant Cabinet-level review?
