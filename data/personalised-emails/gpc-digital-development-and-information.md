...
<h2 style="font-weight: normal; margin-bottom: 1.2em;">Dear <strong>Members of the Government Parliamentary Committee for Digital Development and Information</strong>,</h2>

<p>you sit directly in the line of accountability for the regulator whose pattern is documented at https://pdpaaccessrights.sg. The Government Whip's office, in mooting the GPC in 1987, said its purpose was to serve as an additional channel of feedback on government policy. This email asks the GPC to exercise that function in respect of three documented findings about the Personal Data Protection Commission.</p>
...
<p>I respectfully ask that you consider this documented pattern and what, if anything, can be done within your remit to ensure that the Access Obligation is enforced as Parliament intended.</p>
