...
<h2 style="font-weight: normal; margin-bottom: 1.2em;">Dear <strong>Ms Eileen Chong Pei Shan</strong>,</h2>

<p>Your role as a Non-Constituency Member of Parliament gives you a particular platform to raise issues that might otherwise receive less parliamentary attention. I want to offer you one that I believe fits that description precisely, and that affects Singaporeans beyond my own case.

In March 2025. PDPC removed a filter from its published enforcement-decisions page. That filter had allowed members of the public to segment published cases by obligation type. After the redesign, it is no longer possible to do that without specialist knowledge of the site. The zero Access Obligation breach finding, which had been empirically visible in the data, became inaccessible to most people. This was not announced; it simply changed.</p>
