...
name: Jamie ANG
slug: psd-ds-jamie
email: jamie_ang@psd.gov.sg
designation: Deputy Secretary (Transformation), PSD
...
<h2 style="font-weight: normal; margin-bottom: 1.2em;">Dear <strong>Deputy Secretary (Transformation), PSD Jamie ANG</strong>,</h2>

<p>As Deputy Secretary for Transformation at the Public Service Division, your portfolio covers digital government and service delivery transformation. The documented pattern at pdpaaccessrights.sg reveals a gap between the statutory right of access under the PDPA and its enforcement in practice. That gap is a transformation question as much as a regulatory one.</p>
...
<p>I am asking whether the enforcement gap between the Access Obligation and the Protection Obligation warrants review as a service-delivery issue.</p>
...
<p>CC: kamisah_hassan@psd.gov.sg</p>
