...
VISUAL_SCHEDULE = [
    # ── Cover (pre-roll) ────────────────────────────────────────────
    {"scene": 0, "frame": "cover page.png", "at": 0.00},
    ...
    # ── Scene 3 — The Denials ───────────────────────────────────────
    {"scene": 3, "frame": "generated/scene03_office_refusal.png", "at": 0.00},
    {"scene": 3, "frame": "source/scene03_suites_dpo_reply.png", "at": 0.26},
    {"scene": 3, "frame": "Scene 3.png", "at": 0.52},
    {"scene": 3, "frame": "source/scene03_mcst_guideline_police.png", "at": 0.78},
    ...
    # ── Scene 7 — Two Cases, Two Invented Reasonings ────────────────
    ...
    # ── Scene 8 — Nine Questions, One Response ──────────────────────
    {"scene": 8, "frame": "source/scene08_pdpa_s4_2_4_3.png", "at": 0.00},
    {"scene": 8, "frame": "scene 8.png", "at": 0.08},
    {"scene": 8, "frame": "source/scene08_pdpc_reasonableness.png", "at": 0.30},
    {"scene": 8, "frame": "source/scene08_pdpc_guidelines_prevail.png", "at": 0.52},
    {"scene": 8, "frame": "source/scene08_pdpc_publication_delay.png", "at": 0.78},

    # ── Scene 9 — IMDA ──────────────────────────────────────────────
    {"scene": 9, "frame": "scene 9.png", "at": 0.00},
    {"scene": 9, "frame": "source/scene09_imda_iau_finding.png", "at": 0.45},
    {"scene": 9, "frame": "source/scene09_imda_protocols.png", "at": 0.82},

    # ── Scene 10 — The 384 Cases ────────────────────────────────────
    ...
    # ── Scene 11 — The Only Explanation ─────────────────────────────
    {"scene": 11, "frame": "generated/scene11_citizen_pattern.png", "at": 0.00},
    {"scene": 11, "frame": "Scene 11.png", "at": 0.30},

    # ── Scene 12 — pdpaaccessrights.sg ──────────────────────────────
    ...
    {"scene": 13, "frame": "generated/scene13_evidence_wall.png", "at": 0.00},
    {"scene": 13, "frame": "scene 13.png", "at": 0.70},
]
